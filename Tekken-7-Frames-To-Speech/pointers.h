...
#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x1434F8D48
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {8, 0, 0x7EE8}

#define P1_STATE_STATIC_POINTER P1_RECOVERY_FRAMES_STATIC_POINTER
#define P1_STATE_POINTER_OFFSETS {8, 0, 0x344}

#define P2_STATE_STATIC_POINTER P1_RECOVERY_FRAMES_STATIC_POINTER
#define P2_STATE_POINTER_OFFSETS {8, 0, 0x7A84}
